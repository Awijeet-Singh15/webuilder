            ...
            {open &&
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-md p-[1px] rounded-3xl bg-gradient-to-br from-orange-500/40 via-amber-500/30 to-transparent"
                    ...
                    >
                        <div className='relative rounded-3xl bg-[#0b0b0b] border border-white/10 shadow-[0_30px_120px_rgba(0,0,0,0.8)] overflow-hidden' >
                            <motion.div
                                ...
                                className="absolute -top-32 -left-32 w-80 h-80 bg-orange-500/30 blur-[140px]"
                            />
                            <motion.div
                                animate={{ opacity: [0.2, 0.35, 0.2] }}
                                transition={{ duration: 6, repeat: Infinity, delay: 2 }}
                                className="absolute -bottom-32 -right-32 w-80 h-80 bg-amber-500/25 blur-[140px]"
                            />
                            ...
                            <div className='relative px-8 pt-14 pb-10 text-center'>
                                ...
                                <h2 className='text-3xl font-semibold leading-tight mb-3 space-x-2'>
                                    ...
                                    <span className='bg-linear-to-r from-orange-400 to-red-400 bg-clip-text text-transparent'>Webuilder</span>
                                </h2>
