...
function Generate() {
    ...
    return (
        <div className='relative min-h-screen bg-linear-to-br from-[#050505] via-[#0b0b0b] to-[#050505] text-white overflow-hidden'>
            ...
            <div className='sticky top-0 z-40 backdrop-blur-xl bg-black/50 border-b border-white/10'>
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='flex items-center gap-4'>
                        ...
                        <h1 className='text-lg font-semibold'>Webuilder</h1>
                    </div>
            ...
            <div className='max-w-6xl mx-auto px-6 py-16'>
                ...
                >
                    <h1 className='text-4xl md:text-5xl font-bold mb-5 leading-tight'>
                        Build Websites with
                        <span className='block bg-linear-to-r from-orange-400 to-red-500 bg-clip-text text-transparent'>Real AI Power</span>
                    </h1>
                    <p className='text-zinc-400 max-w-2xl mx-auto'>
                        This process may take several minutes.
                        Webuilder focuses on quality, not shortcuts.
                    </p>
                ...
                <div className='flex justify-center'>
                    <motion.button
                        ...
                        className={`px-14 py-4 rounded-2xl font-semibold text-lg transition ${prompt.trim() && !loading
