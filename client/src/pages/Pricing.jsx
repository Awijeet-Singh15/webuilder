...
const plans = [
    {
        ...
        price: "₹0",
        credits: 100,
        description: "Perfect to explore Webuilder",
        features: [
    ...
    return (
        <div className='relative min-h-screen overflow-hidden bg-[#050505] text-white px-6 pt-16 pb-24'>
            ...
            <div className='relative z-10 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8'>
              ...
              ${p.popular
                                ? "border-orange-500 bg-gradient-to-b from-orange-500/20 to-transparent shadow-2xl shadow-orange-500/30"
                                : "border-white/10 bg-white/5 hover:border-orange-400 hover:bg-white/10"
                            }`}
                    >
                        {p.popular && (
                            <span className='absolute top-5 right-5 px-3 py-1 text-xs rounded-full bg-orange-500'>Most Popular</span>
                        )}
