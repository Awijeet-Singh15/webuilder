...
function WebsiteEditor() {
    ...
    return (
        <div className='relative h-screen w-screen flex bg-black text-white overflow-hidden'>
            <div className='absolute inset-0 pointer-events-none'>
                <div className='absolute -top-40 -left-40 w-[500px] h-[500px] bg-orange-600/10 rounded-full blur-[120px]' />
                <div className='absolute bottom-0 right-0 w-[400px] h-[400px] bg-amber-600/10 rounded-full blur-[120px]' />
            </div>
            ...
            <div className='flex-1 flex flex-col'>
                <div className='h-14 px-4 flex justify-between items-center border-b border-white/10 bg-black/80'>
                    ...
                    <div className='flex gap-2'>
                        {website.deployed ?"": <button className='flex items-center gap-2 px-4 py-1.5 rounded-lg bg-linear-to-r from-orange-500 to-red-500 text-sm font-semibold hover:scale-105 transition'
